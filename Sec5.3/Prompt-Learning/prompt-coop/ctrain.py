...
def reset_cfg(cfg, args):
    ...
    cfg.lda = args.lda
    cfg.khp = args.khp
    cfg.max_itr = args.max_itr
    cfg.ktype = args.ktype
...
def extend_cfg(cfg):
    ...
    cfg.TRAINER.PLOT.PREC = "fp32"  # fp16, fp32, amp
...
if __name__ == "__main__":
    ...
    parser.add_argument("--lda", required=True, type=float)
    parser.add_argument("--khp", type=float, default=None)
    parser.add_argument("--max_itr", type=int, default=100)
    parser.add_argument("--ktype", required=True, type=str)
