...
cifar_trainset, val_set = torch.utils.data.random_split(cifar_trainset, [40000, 10000])

train_dataloader = DataLoader(cifar_trainset, batch_size = batch_size, shuffle = True)
test_dataloader = DataLoader(cifar_testset, batch_size = batch_size, shuffle = True)
